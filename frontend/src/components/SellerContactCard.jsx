...
export default function SellerContactCard({ item, stats }) {
  ...
  const whatsappNumber = (item.whatsappNumber || seller?.phone)?.replace(/[^\d+]/g, "");
